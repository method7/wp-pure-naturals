...
if (!class_exists('CWG_Instock_Privacy_Checkbox')) {
    ...
    class CWG_Instock_Privacy_Checkbox {
        ...
        public function register_settings() {
            ...
            add_settings_section('cwginstock_section_iagree', __('I Agree Checkbox in Subscribe Form', 'cwginstocknotifier'), array($this, 'iagree_settings_heading'), 'cwginstocknotifier_settings');
            add_settings_field('cwg_instock_enable_iagree', __('Enable I Agree in Subscribe Form', 'cwginstocknotifier'), array($this, 'enable_iagree'), 'cwginstocknotifier_settings', 'cwginstock_section_iagree');
            add_settings_field('cwg_instock_iagree_message', __('Text for I Agree - this will appear next to the checkbox frontend', 'cwginstocknotifier'), array($this, 'iagree_text'), 'cwginstocknotifier_settings', 'cwginstock_section_iagree');
            add_settings_field('cwg_instock_iagree_error', __('I Agree Error Message', 'cwginstocknotifier'), array($this, 'iagree_error'), 'cwginstocknotifier_settings', 'cwginstock_section_iagree');
        }

        public function iagree_settings_heading() {
            _e("I Agree Checkbox(GDPR Compliance) in Subscribe Form Frontend", "cwginstocknotifier");
        }
        ...
        public function enable_iagree() {
            ...
            <p><i><?php _e("Select this option to enable I Agree Checkbox in Subscribe Form(Ex: I Agree to the terms and privacy policy)", 'cwginstocknotifier'); ?></i></p>
            <?php
        }
        ...
        public function iagree_text() {
            $options = get_option('cwginstock_iagree_settings');
            ?>
            <textarea rows="5" cols="50" name="cwginstock_iagree_settings[iagree_text]"><?php echo $this->api->sanitize_textarea_field($options['iagree_text']); ?></textarea>
            <?php
        }
        ...
        public function iagree_error() {
            $options = get_option('cwginstock_iagree_settings');
            ?>
            <textarea rows="5" cols="50" name="cwginstock_iagree_settings[iagree_error]"><?php echo $this->api->sanitize_textarea_field($options['iagree_error']); ?></textarea>
            <?php
        }
        ...
        public function show_iagree_frontend($product_id, $variation_id) {
            ...
            if ($is_enable && $get_text) {
                ?>
                <div class="cwg_iagree_checkbox"> <label for="cwg_iagree_checkbox_input"> <input type="checkbox" id="cwg_iagree_checkbox_input" class="cwg_iagree_checkbox_input" value="1" name="cwg_iagree_checkbox_input">  <?php echo $get_text; ?></label> </div>
                <?php
            }
        }
    ...
    new CWG_Instock_Privacy_Checkbox();
}