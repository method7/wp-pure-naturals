    ...
    class CWG_Instock_Notifier_Privacy {
        ...
        public function register_instock_notifier_exporter($exporters) {
            $exporters ['back-in-stock-notifier'] = array(
                'exporter_friendly_name' => _x("Back In Stock Notifier", 'GDPR Privacy', 'cwginstocknotifier'),
        ...
        public function register_instock_notifier_eraser($erasers) {
            $erasers['back-in-stock-notifier'] = array(
                'eraser_friendly_name' => _x("Back In Stock Notifier", 'GDPR Privacy', 'cwginstocknotifier'),
            ...
            if ($get_posts) {
                foreach ($get_posts as $each_post) {
                    ...
                    $to_be_export[] = array(
                        ...
                        'group_label' => _x('Back In Stock Notifier Lists', 'GDPR privacy', 'cwginstocknotifier'),
