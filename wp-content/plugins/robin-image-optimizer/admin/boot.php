<?php
	 ...
	 * @return bool
	 */
	/*add_action('wbcr_factory_429_imppage_after_form_save', function ($plugin, $obj) {
	...
	add_filter( 'wbcr_factory_pages_429_imppage_rating_widget_url', 'wio_rating_widget_url', 10, 2 );
	 ...
	 * Уведомления создаются только если квота <= 100
	 *
	 * @param Wbcr_Factory429_Plugin $plugin Экземпляр плагина, который передается в функцию обратного вызова
	 * @param Wbcr_FactoryPages429_ImpressiveThemplate $obj Экземпляр страницы, который передается в функцию обратного вызова
	 *
	 * @author Alexander Gorenkov <g.a.androidjc2@ya.ru>
	 * @since  1.4.2
	 */
