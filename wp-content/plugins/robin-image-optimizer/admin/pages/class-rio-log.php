				...
				function wrioLogCleanup(element) {
					...
					jQuery.ajax({
						...
						success: function(data) {
							...
							jQuery.wbcr_factory_clearfy_221.app.showNotice(data.message, data.type);
						},
						error: function(jqXHR, textStatus, errorThrown) {
							jQuery.wbcr_factory_clearfy_221.app.showNotice('Error: ' + errorThrown + ', status: ' + textStatus, 'danger');
							btn.html(currentBtnText);
						}
					});
				}
