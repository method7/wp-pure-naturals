...
#flash_sale-shortcodes-form-tab_accordion .flash_sale-shortcodes-toggle-icon-list { margin: 0 0 10px 0; }\
		...
		<div class="flash_sale-shortcodes-form-types">\
			<ul>\
				...
				<li class="flash_sale-shortcodes-form-type-columns" type="thumbnails"><a href="#">Brands Thumbnail(For Pro)</a></li>\
				<li class="flash_sale-shortcodes-form-type-columns" type="product_carousel"><a href="#">Products Carousel By Brands(For Pro)</a></li>\
				<li class="flash_sale-shortcodes-form-type-social" type="product_grid"><a href="#">Products Grid By Brands(For Pro)</a></li>\
				<li class="flash_sale-shortcodes-form-type-social" type="filter_brand"><a href="#">Products List Category and Brand`s Fillter(For Pro)</a></li>\
			</ul>\
		</div><!-- end types -->\
...
<!--Brand Thumbnails-->\
			<div class="flash_sale-shortcodes-form-tab" id="flash_sale-shortcodes-form-tab_thumbnails">\
				<h2>Add Shortcode Thumbnails (Only in Pro Version)<a href="http://codecanyon.net/item/woocommerce-brands/8039481?ref=proword?ref=proword" target="blank"> Click Here</a></h2>\
				<div class="flash_sale-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
...
<!-- Products By Brand`s Carousel -->\
			<div class="flash_sale-shortcodes-form-tab" id="flash_sale-shortcodes-form-tab_product_carousel">\
				<h2>Select Brand For Display Product`s Carousel(Only in Pro Version)<a href="http://codecanyon.net/item/woocommerce-brands/8039481?ref=proword?ref=proword" target="blank"> Click Here</a></h2>\
				<div class="flash_sale-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						<th><label>Brands</label></th>\
					...
					<tr>\
						...
						<td>\
							<select fieldname="type" class="pw_list_view_layout">\
								...
								<option value="adv1">Advanced Layout 1(In Pro)</option>\
								<option value="adv2">Advanced Layout 2(MultiSelect)(In Pro)</option>\
							</select>\
						</td>\
					</tr>\
					\
...
<!-- products Grid-->\
			<div class="flash_sale-shortcodes-form-tab" id="flash_sale-shortcodes-form-tab_product_grid">\
				<h2>Add products List By Brand`s (Only in Pro Version)<a href="http://codecanyon.net/item/woocommerce-brands/8039481?ref=proword?ref=proword" target="blank"> Click Here</a></h2>\
				<div class="flash_sale-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						<th><label>Brands</label></th>\
...
<!--Brand Fillter Category-->\
			<div class="flash_sale-shortcodes-form-tab" id="flash_sale-shortcodes-form-tab_filter_brand">\
				<h2>Add Shortcode(Only in Pro Version) <a href="http://codecanyon.net/item/woocommerce-brands/8039481?ref=proword?ref=proword" target="blank"> Click Here</a></h2>\
				<div class="flash_sale-shortcodes-form-fields">\
				<table cellpadding="0" cellspacing="0">\
					<tr>\
						<th><label>Category For Fillter</label></th>\
