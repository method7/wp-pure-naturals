...
class WPF_Log_Handler {
	...
	public function show_logs_section() {
		...
		<div class="wrap">
			...
			<span class="description" style="display: inline-block; padding: 5px 0;"><?php printf( __( 'For more information on the logs, %1$ssee our documentation%2$s.', 'wp-fusion' ), '<a href="https://wpfusion.com/documentation/getting-started/activity-logs/" target="_blank">', '</a>' ); ?></span>
