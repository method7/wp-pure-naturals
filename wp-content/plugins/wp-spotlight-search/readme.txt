=== Advanced WP Admin/Dashboard Spotlight Search ===
Contributors: rajkuppus
Tags: admin search, advanced admin search, menu search, dashboard, wp-admin, wp admin dashboard,custom menu search, Manage WordPress, WordPress manager, advanced dashboard search, quick search, fast search
Requires at least: 3.1
Tested up to: 5.4.2
Stable tag: trunk

Advanced WP Admin/Dashboard Spotlight Global Search is a powerful quick navigation plugin for WordPress Dashboard - it is an advancement of the default WordPress dashboard search.

== Description ==

Advanced WP Admin/Dashboard is a powerful global quick navigation search plugin for WordPress Dashboard - it is an advancement of the default WordPress dashboard search.
